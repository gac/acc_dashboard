...
@synthesize applicationDetailViewController;
...
- (void)tableView:(UITableView *)aTableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
     ...
     */
	self.applicationDetailViewController=(ApplicationDetailViewController *)[[self.appDelegate.splitApplicationsViewController.viewControllers objectAtIndex:1] visibleViewController];
    self.applicationDetailViewController.itemID = [NSString stringWithFormat:@"%@", _selectedProject.projectID];
